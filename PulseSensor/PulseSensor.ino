...
//      normal1 = ((float)pulseSensor.getLatestSample(i) - (float)pulseSensor.getPulseAmplitude(i)) / (float)pulseSensor.getPulseAmplitude(i);
    }
  }
  normal1 = ((float)pulseSensor.getLatestSample(0) - (float)pulseSensor.getPulseAmplitude(0)) / (float)pulseSensor.getPulseAmplitude(0);
  normal2 = ((float)pulseSensor.getLatestSample(1) - (float)pulseSensor.getPulseAmplitude(1)) / (float)pulseSensor.getPulseAmplitude(1);
